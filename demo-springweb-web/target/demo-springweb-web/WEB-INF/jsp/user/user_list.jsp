					...
					<table cellpadding="0" class="table">
						...
						<c:forEach items="${list}" var="u" varStatus="status">
							<tr>
								...
								<td><a href="<%=ctx%>/user/${u.id}.html">编辑</a>&nbsp;<a href="<%=ctx%>/user/delete/${u.id}.html">删除</a>&nbsp;|&nbsp;<a href="<%=ctx%>/user/${u.id}">JSON</a>&nbsp;<a href="<%=ctx%>/user/${u.id}.xml">XML</a>&nbsp;<a href="<%=ctx%>/user/${u.id}.xlsx">XLSX</a>&nbsp;<a href="<%=ctx%>/user/${u.id}.pdf">PDF</a>&nbsp;<a href="<%=ctx%>/rest/user/sse/${u.id}">SSE</a></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
