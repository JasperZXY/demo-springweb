...
public class UserEntity implements Serializable {
    ...
    public String toString() {
        ...
        builder.append("UserEntity [id=").append(id).append(", name=").append(name).append(", gender=").append(gender).append(", age=").append(age).append(", birthday=").append(birthday).append(", " +
